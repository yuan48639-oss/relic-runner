...
《遗迹奔跑者》是一款小型 2D 动作闯关游戏。你将从家园出发，闯入会重组的沙海遗迹，用二段跳、冲刺、踩怪和剑击突破机关，并把金币带回家园升级装备。
...
- 晨辉核心生命上限升级。
- Boss 掉落技能，当前原型技能为炎爆术。
- 中文和英文界面、暂停、设置、死亡、复活和通关流程。

这个 Demo 用来验证核心手感、关卡节奏和家园成长循环。完整版会在此基础上扩展更多区域、敌人、机关、Boss、装备和技能。
